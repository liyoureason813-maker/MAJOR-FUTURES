...
## V4.2.1 修正
- 移除霍兰德预览图底部的 “YOUR CODE” 占位文字。
- 将六边形图整体上移，避免 E 轴标签与底部信息栏重叠。


## V4.2.1.1 热修复
- 修复职业兴趣测评中每选择一个答案，测评弹窗都会跳回顶部的问题。
- 答题后只局部更新当前选项、答题进度和“下一组”按钮，不再重建整页。
- 增加选项的 `aria-pressed` 状态，改善键盘与辅助技术可访问性。
