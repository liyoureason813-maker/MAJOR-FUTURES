const majors = [
  {
    ...
    "safe": [
      ...
      },
      {
        ...
        "why": "真正困难的是理解医疗、金融或制造场景，而不只是把代码写出来。",
  ...
  },
  {
    ...
    "safe": [
      ...
      },
      {
        ...
        "why": "最终要对传播效果、社会影响和团队产出负责，AI更像工具而不是负责人。",
  ...
  },
  {
    ...
    "safe": [
      ...
      },
      {
        ...
        "entry": "本科",
        "preferred": "研究型硕士或博士",
        "why": "真正有价值的是提出新问题、设计实验和解释因果，而不是只整理已有资料。",
  ...
  },
  {
    ...
    "safe": [
      ...
      },
      {
        ...
        "why": "价值来自真实关系、长期观察和个人判断，而不是快速生成素材。",
  ...
  },
  {
    ...
    "safe": [
      ...
      },
      {
        ...
        "why": "真正的价值来自产业理解、政策判断和复杂融资结构，而不是只做表格。",
  ...
  },
  {
    ...
    "safe": [
      ...
      },
      {
        ...
        "entry": "本科",
        "preferred": "硕士或深厚工程经验",
        "why": "工作对象本身就是复杂软件生态，需要解决新问题而不是重复写功能。",
    ...
    "safe": [
      {
        ...
        "entry": "本科",
        "preferred": "硕士或博士较常见",
        "why": "要回答政策或商业措施是否真正造成结果，需要严谨设计而不是相关性。",
    ...
    "safe": [
      {
        ...
        "why": "这类工作不是只预测结果，而是要在成本、资源、时间和风险等多重限制下设计可执行方案，模型结构和现实约束都需要深入判断。",
...
const UI = {
  "zh": {
    ...
    "heroLead": "从 28 个主流专业出发，拆解 252 个具体方向、756 个岗位示例与学历路径。看清哪些基础工作正在被重写，哪些能力更值得长期投入。",
    "startExplore": "开始探索",
    "randomMajor": "随机查看一个专业",
    "panelTitle": "FUTURE SIGNALS",
    "panelDate": "2026.07 · V2.3",
    "high": "AI 高危区",
    ...
    "exploreTitle": "从专业，走到具体职业路径",
    "exploreDesc": "每张卡片直接展示高危方向、更稳方向、岗位示例和学历提示；点击后可查看完整的 9 个方向。",
    ...
    "legendNote": "判断的是具体方向和岗位，不是给整个专业贴“好”或“坏”的标签。",
    "noMatch": "没有匹配的专业",
    "noMatchSub": "试试更短的关键词或切换专业类别。",
    "methodEye": "HOW TO READ THE MAP",
    "methodTitle": "判断一个方向，先看每天具体做什么",
    "methodDesc": "不用记复杂术语。看工作是否标准化、是否必须面对真人或现场，以及出错后谁承担责任。",
    "ringTop": "真正的分界线",
    "ringMain": "不是专业名称",
    "ringSmall": "同一个专业里，模板化执行和复杂判断的前景可能完全不同。",
    "ringNote": "网站把每个专业拆成 9 个方向，再列出对应岗位与学历要求，帮助学生从“想学什么”继续追问到“毕业后具体做什么”。",
    "m1t": "工作是不是完全在电脑上完成？",
    "m1p": "只处理文字、表格、代码或图片的工作，比需要实验、设备、施工和面对真人的工作更容易自动化。",
    "m2t": "步骤是不是固定的？",
    "m2p": "如果每次都按照同样的流程、模板和规则完成，AI就更容易稳定执行。",
    "m3t": "结果是不是很容易检查？",
    "m3p": "有标准答案、自动测试或明确指标的工作，更容易在较少人工审核的情况下完成。",
    "m4t": "做错会不会造成严重后果？",
    "m4p": "医疗、安全、工程签字、监管和重大投资等工作，需要有人承担责任，不会轻易完全交给AI。",
    "m5t": "是否需要与人建立信任？",
    "m5p": "咨询、治疗、谈判、管理和采访依赖长期关系、文化理解与现场反应。",
    "m6t": "是否必须接触设备和现场？",
    "m6p": "实验、施工、制造、临床和野外工作会遇到大量意外情况，AI通常只能辅助。",
    "principleSmall": "没有哪个方向能保证永远不受AI影响。",
    "principleMain": "更好的选择，是让AI提高效率，而把重要的判断、沟通、现场处理和责任留在自己手里。",
    "strategyEye": "APPLICATION STRATEGY",
    "strategyTitle": "面向高中生的四条申读原则",
    "s1t": "不要只看专业名称，要看具体方向",
    ...
    "disclaimer1": "本网站不是就业保证、薪资预测或专业排名。“常见入门学历”只是多数岗位的典型起点，不代表所有机构都一样。临床心理、药学、医学物理、工程签字等岗位，应以目标国家或地区的注册与执照要求为准。",
    "disclaimer2": "研究整理日期：2026年7月14日。建议每 6–12 个月复核一次。",
    "footerText": "看清方向、岗位与学历，再决定一个专业是否适合自己。",
    "backTop": "返回顶部 ↑",
    "compare": "专业对比",
    "selected": "已选择",
    "clear": "清空",
    ...
    "detailStatus": "下面列出 3 个高危方向、3 个骑线方向和 3 个相对安全方向。",
    "killLine": "什么样的工作最容易被AI替代",
    ...
    "eduTitle": "按方向查看岗位和学历",
    "eduNote": "“起步学历”是多数岗位常见的第一步，不是绝对门槛；“核心或高级岗位”说明继续读研、考执照或积累行业经验通常在哪里更重要。",
    "colZone": "方向所处位置",
    "colDirection": "具体方向",
    "colJobs": "可能从事的岗位",
    "colEntry": "通常从什么学历起步",
    ...
    "compareTitle": "专业横向对比",
    "compareIntro": "对比的是具体方向、岗位和学历要求，不是简单给专业排名。",
    "compareMajor": "专业",
  ...
  "en": {
    ...
    "heroLead": "Explore 28 major fields, 252 specialised tracks, 756 role examples and their education pathways. See which entry-level tasks are being rewritten—and which capabilities are worth building for the long term.",
    ...
    "exploreEye": "EXPLORE THE ATLAS",
    "exploreTitle": "Move from a major to a real career pathway",
    "exploreDesc": "Each card previews an exposed track, a more resilient track, representative roles and education signals. Open it to see all nine tracks.",
    ...
    "methodEye": "HOW TO READ THE MAP",
    "methodTitle": "Judge the work people do—not the label on the degree",
    "methodDesc": "No jargon required. Look at how standardised the work is, whether it involves people or physical settings, and who carries responsibility when something goes wrong.",
    "ringTop": "The real dividing line",
    "ringMain": "is the work itself",
    "ringSmall": "Within one major, template execution and complex judgement can have completely different futures.",
    "ringNote": "The atlas breaks every major into nine tracks, with linked roles and education requirements, so students can move from “what should I study?” to “what would I actually do?”.",
    "m1t": "Can the work happen entirely on a screen?",
    ...
    "principleSmall": "No track is guaranteed to remain untouched by AI.",
    "principleMain": "The stronger strategy is to use AI for speed while keeping important judgement, communication, field decisions and accountability in human hands.",
    "strategyEye": "APPLICATION STRATEGY",
    "strategyTitle": "Four principles for students choosing a degree",
    ...
    "footerText": "Choose a major after you understand its tracks, roles and education pathways.",
    "backTop": "Back to top ↑",
...
function applyStaticI18n(){
 ...
 document.title=isEn()?"MAJOR FUTURES | AI-era Major & Career Atlas V2.3":"MAJOR FUTURES｜专业与AI职业地图 V2.3";
...
function openMajor(id){const m=majors.find(x=>x.id===id),b=band(m.risk),color=categoryColors[m.category];document.querySelector("#dialogContent").innerHTML=`<section class="detail-hero" style="--detail:${color}"><div class="detail-meta">${catName(m.category)} · V2.3 · ${t("detailMeta")}</div><div class="detail-title-row"><div><h2>${majorName(m)}</h2><p>${isEn()?m.name:m.en}</p></div></div><div class="detail-status"><span class="impact-badge" style="--accent:${b.color}">${t("overall")}${colon()}${b.label}</span><span>${t("detailStatus")}</span></div><p class="detail-overview">${overview(m)}</p></section><div class="kill-line"><strong>${t("killLine")}</strong><p>${isEn()?thresholdEn(m):m.threshold}</p></div><div class="detail-body"><div class="zone-stack">${zone(t("high"),t("zoneHighTag"),m.high,"high")}${zone(t("border"),t("zoneBorderTag"),m.border,"edge")}${zone(t("safe"),t("zoneSafeTag"),m.safe,"safe")}</div><section class="detail-section"><h3>${t("eduTitle")}</h3><p class="section-note">${t("eduNote")}</p><div class="education-scroll"><table class="education-table"><thead><tr><th>${t("colZone")}</th><th>${t("colDirection")}</th><th>${t("colJobs")}</th><th>${t("colEntry")}</th><th>${t("colAdvanced")}</th></tr></thead><tbody>${educationRows(m)}</tbody></table></div></section><section class="detail-section advice-section"><h3>${t("adviceTitle")}</h3><ul class="advice-list">${advice(m).map(x=>`<li>${x}</li>`).join("")}</ul></section></div>`;majorDialog.style.setProperty("--detail",color);majorDialog.showModal();}
